...
#include <sstream>
#include <RP_DatabaseConnector/exceptions.h>
#include <RP_DatabaseConnector/date_time.h>
#include <RP_DatabaseConnector/time.h>
#include <RP_DatabaseConnector/conversion_helper.h>
#include <RP_DatabaseConnector/private.h>
#include <iomanip>
#include <chrono>
...
mariadb::time::time(const MYSQL_TIME &t) {
    set(t.hour, t.minute, t.second, t.second_part / 1000);
}
