...
RPCore/RPA_ErrorHandle/%.o: ../RPCore/RPA_ErrorHandle/%.cpp
	...
	arm-linux-gnueabihf-g++ -I"D:\wiringPi\wiringPi" -I"D:\RasBerryPiApplications\RasBerryPiSoftware\RPSystem\RPCore\RPA_ErrorHandle" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
