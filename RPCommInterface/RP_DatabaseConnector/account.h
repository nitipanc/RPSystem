...
#ifndef RPCOMMINTERFACE_RP_DATABASECONNECTOR_ACCOUNT_H_
#define RPCOMMINTERFACE_RP_DATABASECONNECTOR_ACCOUNT_H_
...
public:
	 ...
	 */
	void set_ssl(const std::string &key, const std::string &certificate,
			const std::string &ca, const std::string &ca_path,
	 ...
	 * ignored
	 */
	static account_ref create(const std::string &host_name,
			const std::string &user_name, const std::string &password,
			const std::string &schema = "", u32 port = 3306,
...
private:
	 ...
	 */
	account(const std::string &host_name, const std::string &user_name,
