...
#ifndef RPCOMMINTERFACE_RP_DATABASECONNECTOR_STATMENT_H_
#define RPCOMMINTERFACE_RP_DATABASECONNECTOR_STATMENT_H_

#include <RP_DatabaseConnector/last_error.h>
